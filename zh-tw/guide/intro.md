...
GMWalletApp 組織也維護 [GMPay Edge](/zh-tw/gmpay-edge/)。它是支援 Cloudflare Workers 或 Node/Nitro Docker 的獨立閘道，共用 GMPay / EPay 商戶協議語境，但不是 Epusdt 的同一套執行時或部署模型。

如果需要數位商品商城，請看 [GMShop Edge](/zh-tw/gmshop-edge/)，它是獨立的 Cloudflare Workers 商城，負責商品、結帳、交付與管理後臺。
