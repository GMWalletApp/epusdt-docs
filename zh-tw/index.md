...
hero:
  ...
  actions:
    - theme: brand
      text: 快速開始
      link: /zh-tw/guide/intro
    - theme: alt
      text: Docker 部署
      link: /zh-tw/guide/installation/docker
    - theme: alt
      text: API 文件
      link: /zh-tw/api/reference
    - theme: alt
      text: GMPay Edge
      link: /zh-tw/gmpay-edge/
    - theme: alt
      text: GMShop Edge
      link: /zh-tw/gmshop-edge/
...
features:
  ...
  - icon: ⚡
    ...
    details: GMWalletApp/gmpay-edge 是支援 Cloudflare Workers 或 Bun/Nitro Docker 的獨立閘道，支援 GMPay HMAC-SHA256 與 EPay 相容流程。
  - icon: 🛒
